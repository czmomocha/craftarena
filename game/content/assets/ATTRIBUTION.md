...
**已知边界**：上游不含 emoji，S1 大厅的 🔒 在桌面走引擎系统回退、**在 Web 上直接缺**；只有 Regular 一个字重，加字重约 +800 KB 一份，需人类拍板。完整口径在 [CD-11 §8.2 第 3 条](../../../Confirmed-docs/10-product/11-scope-and-platforms.md)，此处不复述（宪法第二十六条）。
