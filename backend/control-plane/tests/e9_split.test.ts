...
const SPLIT_FILES = [
	...
	"backend/control-plane/src/server_settlement.ts",
	...
	"backend/control-plane/src/server_replay.ts",
	"backend/control-plane/src/server_identity.ts",
	...
	"backend/control-plane/src/db/database_replays.ts",
