...
> 日期：2026-09-16。状态：**D1–E4 已交，F1 起未开工。** 八项已拍板或按诚实边界落地（§5.1）；§5.2 无余项。D 段交的是**全离线的玩法底座**；E1 交了协议帧与服务端裁剪；E2 交了第一张官方蓝图；E3 交了对局进程分派、匹配 HTTP 玩法位与结算队伍结果；**E4 交了客户端对局壳**（第一次有画面是 E4）。S1 主大厅仍是 F1。
...
| D1–E4 | **已交**（E4：2026-09-16）。下一刀是 **F1**（S1 主大厅壳），不提前、不单独开工 |
...
D1–E4 落地时这条门禁**收窄过**：原先钉的是「BASTION 一行实现都没有」，那句话在 D1 之后就假了；后来钉「E1 起未开工」……「E4 起未开工」，交完那句也假了。现在改钉三件仍然为真、且同样容易被顺手抹掉的事——F1 起未开工、§4 引子里那句「第一次有画面是 E4」、M6 未退出。
...
| 把 CD-61 §2 M6 里「F1 起**未开工**」改成「已全部交付」 | 非零 | `exit=1`，6 项里 1 项红 |
