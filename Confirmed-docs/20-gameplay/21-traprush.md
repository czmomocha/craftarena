...
吸附格、楼层查询与传送连线分类的数据落点见 [CD-32 §3](../30-ugc/32-editor-and-preview.md#3-从编辑到预览)。连线可视化、检查点可视化、可达性检测与 Preview 仍待。通用编辑器框架与预览行为见 [CD-32](../30-ugc/32-editor-and-preview.md)。
