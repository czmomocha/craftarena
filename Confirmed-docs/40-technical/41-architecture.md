...
| `CreatorTools` | 共用编辑器外壳（代码创建 Editor 窗口）、玩法专用工具面板、EditCommand、Undo/Redo、AuthoringDocument、独立持续 Preview 窗口、编辑与 Preview 共用 3D 占位映射、传送连线、检查点顺序与可达性叠加 gizmos |
