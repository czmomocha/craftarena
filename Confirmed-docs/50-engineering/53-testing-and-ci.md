...
- 对局大厅本席摄像机跟随：`follow_slot` 把 SnapshotCamera 对准该席表现位姿（偏移与 Preview 相同）；缺席/空名单看原点；Solo 跟本地盒、线上跟本席不跟远端；Cancel 回到原点；人类真机步骤见 [章节真机清单](../../docs/runbooks/chapter-device-check.md) 本刀（人工检查，非 CI 门禁）；
