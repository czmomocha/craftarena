...
- 开发机运行窗口与空格跳跃：大厅/Preview 动作按钮 `FOCUS_NONE`，LineEdit `FOCUS_CLICK`；空格不点 Solo play / Play；`jump` 动作仍是空格；项目运行窗 1600×900 最大化，Traprush/Preview 窗 1280×720 最大化；不是产品镜头/FOV；GUT 910/910、`npm test` 319；人类真机步骤见 [章节真机清单](../../docs/runbooks/chapter-device-check.md) 本刀（人工检查，非 CI 门禁）；
