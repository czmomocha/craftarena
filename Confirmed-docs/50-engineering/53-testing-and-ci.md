...
| 内容发布和回滚演练 | 部分 | M4b 第 1–5 章已交哈希/HMAC、`latest` 原子切换、新房/旧房并存、P0/P1 回滚、广场列表与账号认领；持钥 `POST /content/publish` 仍不绑账号。玩家代签 / 广场 GET 已交（M5 C3）；匹配 UGC 已拍未接线（M5 C4），不把未实现路径写成已覆盖 |
