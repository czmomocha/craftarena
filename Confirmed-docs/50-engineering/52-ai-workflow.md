...
并行度上限 **3**，先跑 **2** 个域，确认审查节奏后再加第 3 个。不要一上来开 5 个。九轮已确认可继续两域；第 3 域仍未开。阶段 B 的域划分与 M2 启动前工具链评审见 [CD-61](../60-plan/61-milestones.md)。
