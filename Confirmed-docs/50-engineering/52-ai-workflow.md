...
并行度上限 **3**，先跑 **2** 个域，确认审查节奏后再加第 3 个。不要一上来开 5 个。M1 已退出；M2 启动前须完成工具链评审。第 3 域仍未开。域划分与评审见 [CD-61](../60-plan/61-milestones.md)。
