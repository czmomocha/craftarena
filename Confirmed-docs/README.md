...
| CD-52 | [52-ai-workflow.md](50-engineering/52-ai-workflow.md) | 人机分工、任务循环、任务单模板、完整章节提交的人类真机步骤义务、AI 使用规则、多 Agent 与协作约定、Godot AI MCP 使用边界 |
...
| ID | 文档 | 内容 |
|---|---|---|
| CD-61 | [61-milestones.md](60-plan/61-milestones.md) | M0–M3 / M-Export / M-Art / M4a / M4b / M5–M7、插入段（创作者可测 / F 线 / 可玩性深化）、CD-11 §4 所有者、阶段退出条件、首个可运行验收场景 |
...
| AI 权限边界、工作流、完整章节提交的人类开发机窗口验收步骤义务与 Godot AI 使用边界 | CD-52 |
