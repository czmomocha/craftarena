...
- 当前阶段：M1 已退出（2026-08-23）。下一阶段是 M2，启动前须完成工具链评审。退出依据见 [CD-61](Confirmed-docs/60-plan/61-milestones.md)。
