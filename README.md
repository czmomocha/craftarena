...
- 当前阶段：M1 阶段 B 进行中（弧节奏；出界复位与打箱入带见 [PR #72](https://github.com/czmomocha/craftarena/pull/72)；第 3 域未开）。进度与退出条件见 [CD-61](Confirmed-docs/60-plan/61-milestones.md)。
